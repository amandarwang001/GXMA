<div class="row">
    <div class="col s12 m9 l10">
        ...
        <div id="australia" class="section scrollspy">
            ...
            <ul class="collapsible popout" data-collapsible="accordion">
                <li>
                    <div class="collapsible-header"><i class="material-icons red-text text-darken-4">arrow_drop_down_circle</i>Group
                        Classes
                    </div>
                    <div class="collapsible-body grey darken-2 white-text">
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons red-text text-darken-4">arrow_drop_down_circle</i>Private
                        Lessons
                    </div>
                    <div class="collapsible-body grey darken-2 white-text">
                        Location: Private (please contact for location)<br>
        ...
        <div id="video" class="section scrollspy grey lighten-4">
            ...
            <ul class="collapsible popout" data-collapsible="accordion">
                <li>
                    <div class="collapsible-header"><i class="material-icons red-text text-darken-4">arrow_drop_down_circle</i>Video
                        Classes
                    </div>
                    <div class="collapsible-body grey darken-2 white-text">
